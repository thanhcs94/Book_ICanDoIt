...
public class ChapterViet extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		lvnoidung.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				Intent inten = new Intent(ChapterViet.this, ViewData.class);
				inten.putExtra("Data", noidungviet[arg2]);
				inten.putExtra("postion", arg2);
				inten.putExtra("language", VIET);

				startActivity(inten);
				//	Toast.makeText(Chapter.this, "Title => "+title[arg2]+" n Description => "+desc[arg2], Toast.LENGTH_SHORT).show();
	...
	public boolean onContextItemSelected(MenuItem item) {
...

		{
			...
			lvnoidung.setOnItemClickListener(new AdapterView.OnItemClickListener() {
				...
				@Override
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
					Toast.makeText(ChapterViet.this, "Title => "+title[arg2]+" n Description => "+desc[arg2], Toast.LENGTH_SHORT).show();
